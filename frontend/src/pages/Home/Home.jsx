      ...
      <div id='home-page-container'>
        <div class="row row-cols-1 row-cols-md-2 text-center">
          <div class="col mb-5" onClick = {() => {
            ...
            <div class="home-card card shadow" style={{ marginRight: '5px', width: '35rem' }}>
          ...
          <div class="col mb-5" onClick = {() => {
            ...
            <div class="home-card card shadow right-card" style={{ marginLeft: '5px', width: '35rem' }}>
          ...
          <div class="col mb-5"  onClick = {() => {
            ...
            <div class="home-card card shadow" style={{ marginLeft: '5px', width: '35rem' }}>
